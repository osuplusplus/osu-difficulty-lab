...
## Key-pattern analysis (`src/mania_mma`)

`src/mania_mma` is a source port of the key-pattern analysis of **osumania_map_analyser**, commit `70e2bd92524e093ee94ca9cb6cc159ec223faa04`, by Leo_Black.
