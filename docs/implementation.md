...
`src/mania_mma` 是 osumania_map_analyser 键型分析的 Rust 移植，固定提交
`70e2bd92524e093ee94ca9cb6cc159ec223faa04`，模块与上游文件一一对应：
...
移植保留上游的常量、匹配顺序、取整方式与稳定性排序，主模式取重要度最高的簇的细分键型，
